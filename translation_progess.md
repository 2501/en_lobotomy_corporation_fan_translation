...
* If a file is unambiguously done, it should be marked like below:
    * DONE: Transliterated (or "Korean-Translated", if that's the case).
...
* Mission_en
* OrdealTypo_en
* RabbitConversation_en
* SefiraAbilityDesc_en
* SefiraBossDesc_en
* TextData_en
* Tooltip_en
* WorkProcess_en
